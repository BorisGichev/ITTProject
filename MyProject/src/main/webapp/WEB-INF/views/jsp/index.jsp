						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<spring:input type="text" class="form-control" path="username"
									value="markanUser" required="true" />
							</div>
						</div>
					</c:if>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<spring:input type="email" class="form-control" path="email"
									value="markan@abv.bg" required="true" />
							</div>
						</div>
					</c:if>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<spring:input type="password" id="pass1" class="form-control"
								value="kran123" path="password" required="true" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="password" id="pass2" class="form-control"
								value="kran123" name="repPassword"
