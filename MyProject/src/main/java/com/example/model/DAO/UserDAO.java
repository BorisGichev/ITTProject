...
public class UserDAO extends AbstractDBConnDAO implements IUserDAO {
	...
	private static final String UPDATE_USER_INTO_DB = "UPDATE workplan.users SET username = ?, password = ?, avatar_path=?, admin=?, full_name=?,email=?,last_project_id=? WHERE user_id = ?;";
