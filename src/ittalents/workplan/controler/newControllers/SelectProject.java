...
public class SelectProject {
	...
	public String selectProjectForProjecBoard(HttpServletRequest request,Model model,
		...
		} catch (UnsupportedDataTypeException | DBException
				| WorkPlanDAOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
	...
	public String selectProjectForIssue(Model model,
			@ModelAttribute("user") User user,
			@RequestParam("projectId") Integer projectId) {
